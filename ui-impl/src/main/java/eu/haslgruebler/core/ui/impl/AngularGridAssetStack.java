...
public class AngularGridAssetStack extends AssetStack {
    ...
    public AngularGridAssetStack() {
        super(new JavascriptAsset("ng-grid", "2.0.7", "/core-resources/angular/modules/ng-grid-2.0.7.debug.js", new String[] { "jquery", "angular" }), new CSSAsset("ng-grid", "2.0.7", "/core-resources/angular/modules/ng-grid.min.css", (String) null));
    }
}
